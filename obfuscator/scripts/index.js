...
window.onload = () => {
	...
	optionVariableCandidates = 'zxsrxt';
	optionIterationCount = 50;
...
const initCodeArea = () => {
	...
	document.getElementById('obfuscate-button').onclick = () => {
		...
		outputCode.value = obfuscate(inputCode.value, optionVariableCandidates.split(''), iterationCount);
		outputCode.oninput();
	};
